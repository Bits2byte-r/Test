...
class MinecraftTab(QWidget):
    ...
    def init_ui(self):
        ...
        settings_group = QGroupBox("Minecraft clicker settings")
        settings_layout = QVBoxLayout()
        interval_mode_layout = QHBoxLayout()
        interval_mode_layout.addWidget(QLabel("Interval mode:"))
        ...
        interval_layout_fc.addWidget(QLabel("Max interval (ms):"))
    ...
    def update_interval_mode(self):
        ...
        self.interval_spinbox.setToolTip("Clicks per second" if is_cps else "Milliseconds between clicks")
    ...
    def set_settings(self, settings):
        ...
        button_text = settings.get('button', 'LMB')
